...
export class UserDailyAttendanceService {
  ...
  getUserDailyAttendance(filter: ISideFilter): Observable<IUserDailyAttendance[]> {
    ...
    return this.http
      .get<ApiResponse>(environment.api_url + '/api/dailyattendance', { params })
      .pipe(
  ...
  getDailyAttendanceByUserAndDate(user: string, date: Date): Observable<IUserDailyAttendance> {
    ...
    return this.http
      .get<ApiResponse>(environment.api_url + '/api/dailyattendance/getbyuseranddate', { params })
      .pipe(
        map((resp) => resp.data as IUserDailyAttendance),
        catchError(this.handleError)
      );
  ...
  userTimeOut(attendanceId: string): Observable<IUserDailyAttendance> {
    return this.http
      .patch<ApiResponse>(environment.api_url + '/api/dailyattendance/timeout/' + attendanceId, {})
      .pipe(
        map((resp) => resp.data as IUserDailyAttendance),
        catchError(this.handleError)
      );
